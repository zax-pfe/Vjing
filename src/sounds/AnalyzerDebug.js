...
export default class AnalyzerDebug extends EventEmitter {
  ...
  draw = () => {
    ...
    const specH = H - (8 + meters.length * 12),
      f = a.volumeByFrequency,
      N = this.bins;
    const bw = (W - PAD * 2) / N;
    for (let i = 0; i < N; i++) {
